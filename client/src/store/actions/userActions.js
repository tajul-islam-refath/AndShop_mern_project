...
export const register = (userData) => async(dispatch) => {
    ...
    try {
        ...
        dispatch({
            ...
            payload: error.response.data.message ? error.response.data.message : error.response.data.errors
        })
    }
}
...
export const updateUser = (id, userData) => async(dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/user/admin/user/${id}`, userData, config)
