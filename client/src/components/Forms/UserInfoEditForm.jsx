...
import { updateProfile, dashbordClearError } from "../../store/actions/userDashbordActions"
import { DASHBORD_RESET } from "../../store/Types/userTypes"
export default function UserInfoEditForm(
    {
        user: { email, gender, mobile,
    ...
    const { userUpdated, loading, error } = useSelector(state => state.dashbord)
    ...
    useEffect(() => {
        ...
        if (userUpdated) {
            dispatch({ type: DASHBORD_RESET })
            history.push("/user/account")
        }
    }, [error, userUpdated, history])
        ...
        <div className="account__info__edit">
            <form onSubmit={handleSubmit(onSubmit)} >
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <div className="form-group signup__form__password">
                            ...
                            <input
                                ...
                                defaultValue={mobile}
                            />
                            {errors.mobile && <span className="invalid-feedback" >This field is required</span>}
                    ...
                    <div className="col-md-12">
                        <div className="signup__form__birthday__inpute row ">
                        ...
                        <button
                            className="myBtn myBtn__type--one signup__form--btn w-100 mt-3"
                        >
                            SUBMIT
                        </button>
                    </div>
